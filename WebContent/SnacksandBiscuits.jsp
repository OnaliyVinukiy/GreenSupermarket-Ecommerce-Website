...
<%
    ...
    String type = "SnacksandBiscuits"; // Set the type to "mobile" to fetch only mobile products
    String message = "Snacks and Biscuits"; // Change the message accordingly
...
<section class="align-items-center" id="food-menu-section">
	<center><h2 class="topic">Snacks and Biscuits</h2></center>
    <div class="container">
