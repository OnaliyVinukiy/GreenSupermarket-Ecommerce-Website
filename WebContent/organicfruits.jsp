...
<%
    ...
    String type = "OrganicFruits"; // Set the type to "mobile" to fetch only mobile products
    String message = "Organic Fruits"; // Change the message accordingly
...
<section class="align-items-center" id="food-menu-section">
	<center><h2 class="topic">Organic Fruits</h2></center>
    <div class="container">
