...
<%
    ...
    String type = "beauty"; // Set the type to "mobile" to fetch only mobile products
    String message = "beauty"; // Change the message accordingly
    products = prodDao.getAllProductsByType(type);

    if (products.isEmpty()) {
        message = "No Beauty & Healthcare item available";
    }
%>
...
<section class="align-items-center" id="food-menu-section">
	<center><h2 class="topic">Beauty & Healthcare</h2></center>
    <div class="container">
