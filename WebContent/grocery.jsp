...
<%
    ...
    String type = "GroceryItem"; // Set the type to "mobile" to fetch only mobile products
    String message = "Grocery Items"; // Change the message accordingly
...
<section class="align-items-center" id="food-menu-section">
	<center><h2 class="topic">Grocery Items</h2></center>
    <div class="container">
