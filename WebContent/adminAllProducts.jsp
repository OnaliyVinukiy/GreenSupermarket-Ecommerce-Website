...
.cart-btn2 {
    ...
    padding-right: 2rem; /* Add padding to the cart button */
...
<%
    ...
    String type = "AllProducts"; // Set the type to "All Products" initially
	String message = "All Products";
    if (search != null && !search.isEmpty()) {
        products = prodDao.searchAllProducts(search);
        message = "Showing Results for '" + search + "'";
        type = "SearchResults"; // Optionally, set type to indicate search results
    } else {
        products = prodDao.getAllProducts();
        message = "All Products"; // Change the message accordingly
    }
...
<section class="align-items-center" id="food-menu-section">
	<center><h2 class="topic">All Products</h2></center>
    <div class="container">
