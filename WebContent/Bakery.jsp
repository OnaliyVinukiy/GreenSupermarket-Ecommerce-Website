...
<%
    ...
    String type = "other"; // Set the type to "mobile" to fetch only mobile products
    String message = "bakery"; // Change the message accordingly
    products = prodDao.getAllProductsByType(type);

    if (products.isEmpty()) {
        message = "No Bakery item available";
    }
%>
